...
const LoginScreen = () => {
     ...
     const submitData = async() => {
          showLoader()
         await API.post('/login',{email,password,companyId}).then((res) => {
     ...
     return (
       <div className="flex flex-col justify-center items-center relative">
         <img
           alt="circle up"
           className="w-50 fixed top-0 self-end"
           src={circleUp}
         />
         <div className="top-30 absolute flex flex-col justify-center">
           ...
           <div className="flex flex-col jsutify-between items-center">
             <div className="relative w-[300px] ">
               ...
               <input
                 ...
                 type="email"
                 name="n"
                 className="p-2 bg-black/10 mb-5 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-sm"
               />
             </div>
           ...
           <img
             alt="button"
             className="w-10 self-center mt-5 mb-5 cursor-pointer"
             src={wizardbtn}
             onClick={() => submitData()}
           />
         ...
         <img
           alt="ilsutraiton"
           className="z-[999] w-70 fixed bottom-10 right-40 self-end"
           src={illustration}
         />
         <img
           alt="circle down"
           className="w-50 fixed bottom-0 self-start"
           src={circleDown}
         />
       </div>
     );
